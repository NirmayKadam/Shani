...
async def _poll_news_async():
    from app.domain.ingestion.domain.news_fetcher import NewsFetcher
...
async def _poll_prices_async():
    from app.domain.ingestion.domain.market_data_fetcher import MarketPriceFetcher
    from app.domain.ingestion.domain.price_triggers import PriceTriggerDetector
    from app.shared.redis_client import GetRedisClient
...
async def _poll_options_async():
    ...
    from app.domain.ingestion.domain.market_data_fetcher import OptionChainFetcher
    from app.shared.redis_client import GetRedisClient
    from app.shared.database import GetDatabasePool
    from app.shared.constants import Channels, RedisKeys, Streams, TTL
...
async def _refresh_symbol_async(symbol: str):
    ...
    from app.config import GetSettings
    from app.domain.ingestion.domain.market_data_fetcher import MarketPriceFetcher, OptionChainFetcher
    from app.domain.ingestion.domain.news_fetcher import NewsFetcher
    from app.domain.ingestion.domain.price_triggers import PriceTriggerDetector
    from app.shared.constants import Channels, RedisKeys, Streams, TTL
    from app.shared.database import GetDatabasePool
