"""
train_daily_predictor.py — ML Training script for Phase 5.

Usage:
    docker compose exec app python -m scripts.train_daily_predictor
...
to `app/Models/daily_predictor.joblib`.
"""
...
_MODEL_PATH = os.path.join(_MODEL_DIR, "daily_predictor.joblib")
