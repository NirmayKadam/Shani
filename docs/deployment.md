...
AlphaStreams V2 runs in a completely dockerized, single-container setup. All system components (FastAPI, Celery, Redis, and TimescaleDB) are packaged together and orchestrated by `supervisord`.
...
> [!NOTE]
> **First boot** automatically executes TimescaleDB migrations.
